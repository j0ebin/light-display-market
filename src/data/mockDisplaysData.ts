...
export const mockDisplaysData: DisplayWithOwner[] = [
  {
    ...
    description: 'A spectacular holiday light display synchronized to music, featuring over 50,000 LED lights programmed to dance to a variety of Christmas classics and contemporary holiday hits.',
    latitude: 47.6062,
    longitude: -122.3321,
  ...
  },
  {
    ...
    description: 'A charming Christmas village with over 100,000 lights, animated displays, and a walkthrough experience for the whole family.',
    latitude: 45.5152,
    longitude: -122.6784,
    holiday_type: 'Christmas',
    year_started: 2015,
  ...
  },
  {
    ...
    description: 'A high-tech light display featuring projection mapping, animated sequences, and interactive elements controlled via a mobile app.',
    latitude: 37.7749,
    longitude: -122.4194,
    holiday_type: 'Christmas',
    year_started: 2020,
